...
const scrollTop = () => {
  ...
  useEffect(() => {
    ...
    const wheelEvt = isFireFox ? "DOMMousScroll" : "wheel";

    window.addEventListener(wheelEvt, (e) => {
      const delta = e.deltaY ? e.deltaY : -e.detail;

      delta < 0 ? setNavColor(false) : setNavColor(true);
    });
    return () =>
      window.removeEventListener("wheel", (e) => {
        console.log(e.deltaY);
        e.deltaY < 0 ? setNavColor(false) : setNavColor(true);
      });
  }, []);
    ...
    <div>
      <nav>
        <div
          ...
          style={{
            backgroundColor: navColor ? "white" : "black",
